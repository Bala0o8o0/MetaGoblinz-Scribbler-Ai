...
export default function Home() {
  ...
  return (
    <>
      ...
      <main className=" overflow-hidden main_bg_ai min-h-screen p-5 bg-center ">
        ...
        <div className="container max-w-[512px] mx-auto">
          <hgroup>
            ...
            {/* </h1>   */}
            <div className="logo  animate-pulse  flex justify-center " >

            </div>
            <p className="text-center text-yellow-200 font-bold text-xl  m-4">
              {/* {pkg.appSubtitle} */}
